								...
								<table class="code_search_textbox">
									<tbody>
										...
										<tr>
											...
											<td style="border-right:0px;" class="code_sword_choice">
											    <div id="code_sword_choice_option_wrap" class="code_sword_choice_option_wrap">
    												<select class="code_sword_choice_option" id="mshop_post_umd" name="mshop_post_umd">
    													<option value="선택">선택</option>
    												</select>
												</div>	
											</td>
											<td class="keyword_search_field" colspan="2" style="border-right:0px;">
												<table>
													<tr>
														<td>
															<input type="text" id="mshop_post_jibun" name="mshop_post_jibun" class="code_box" class="code_sword_box" value="" placeholder="지번">
														</td>
														<td style="width:50px; text-align: right;">
															<a class="code_search_btn" name="mshop_post_search_button" id="mshop_post_search_button">검색</a>
														</td>
													</tr>
												</table>
											</td>
								...
								<table class="code_search_textbox">
									<tbody>
										...
										<tr>
											<td class="code_sword">상세주소</td>
											<td style="border-right:0px;" class="code_sword_choice">
												<input type="text" name="mshop_road_name" id="mshop_road_name" class="code_box" class="code_sword_box" value="" placeholder="도로명">
											</td>
											<td class="keyword_search_field" colspan="2" style="border-right:0px;">
												<table>
													<tr>
														<td>
															<input type="text" name="mshop_road_bdnum" id="mshop_road_bdnum" class="code_box" class="code_sword_box" value="" placeholder="건물번호">
														</td>
														<td style="width:50px; text-align: right;">
															<a class="code_search_btn" name="mshop_road_search_button" id="mshop_road_search_button">검색</a>
														</td>
													</tr>
												</table>
											</td>
